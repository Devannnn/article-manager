...
function Card({ title, author, year, url }: Readonly<PropsType>) {
  return (
    <div className="group h-full rounded-2xl border border-slate-200 p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800">
      <div className="flex h-full flex-col justify-between gap-4">
        ...
        <div className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2 dark:bg-slate-700/60">
          <span className="max-w-[70%] truncate text-sm font-medium text-slate-600 dark:text-slate-200">
            {author}
          </span>
